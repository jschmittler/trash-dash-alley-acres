...
const encounters = [
  {
    ...
    spawnX: 720,
    enemies: [{ kind: "snake", x: 720, patrol: [660, 790], surfaceId: "ground-woodland" }],
  },
  {
    ...
    spawnX: 1010,
    enemies: [
      { kind: "pigeon", x: 980, patrol: [920, 1080], flightBand: "campsite-canopy" },
      { kind: "pigeon", x: 1060, patrol: [980, 1130], flightBand: "campsite-canopy" },
    ],
  ...
  },
  {
    ...
    spawnX: 1320,
    enemies: [
      { kind: "wasp", x: 1320, y: 330, patrol: [1250, 1450], flightBand: "creek-airspace" },
      { kind: "mosquito", x: 1510, y: 250, patrol: [1430, 1620], flightBand: "creek-airspace" },
    ],
  },
  {
    ...
    enemies: [
      ...
      { kind: "pigeon", x: 1990, patrol: [1880, 2140], flightBand: "mill-loft" },
      { kind: "pigeon", x: 2090, patrol: [1990, 2240], flightBand: "mill-loft" },
    ],
  ...
  },
  {
    ...
    spawnX: 2570,
    enemies: [{ kind: "possum", x: 2570, patrol: [2450, 2750], surfaceId: "ground-highway" }],
  ...
  },
  {
    ...
    spawnX: 3200,
    enemies: [
      { kind: "fox", x: 3180, patrol: [2980, 3370], surfaceId: "ground-highway" },
      { kind: "mosquito", x: 3310, y: 235, patrol: [3150, 3470], flightBand: "highway-airspace" },
    ],
    bypass: "highway-culvert-route",
  },
  {
    ...
    enemies: [
      ...
      { kind: "pigeon", x: 4160, patrol: [4000, 4340], flightBand: "rail-yard-airspace" },
      { kind: "pigeon", x: 4260, patrol: [4100, 4460], flightBand: "rail-yard-airspace" },
    ],
...
const surfaces = [
  ...
  { id: "crate-campsite-right", x: 938, y: 383, w: 112, h: 85, kind: "box" },
