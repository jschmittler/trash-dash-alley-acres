...
export const LEVEL_TWO_PROP_FRAMES = Object.freeze({
  ...
  "loose-acorn-pile": Object.freeze({ frames: Object.freeze([cell(1, 1)]), fps: 0, loop: false }),
  "residential-trash-can": Object.freeze({ frames: Object.freeze([cell(0, 1)]), fps: 0, loop: false }),
...
export const RESIDENTIAL_TRASH_CAN_RENDER_METRICS = Object.freeze({
  drawSize: 112,
});

export const LOOSE_ACORN_PILE_RENDER_METRICS = Object.freeze({
  drawSize: 96,
});
...
export const LAMP_POST_RENDER_METRICS = Object.freeze({
  ...
  visibleBounds: Object.freeze({ x: 43, y: 7, w: 106, h: 248 }),
  sourceLight: Object.freeze({ x: 128, y: 75 }),
});


export function residentialTrashCanDrawRect(item) {
  const size = RESIDENTIAL_TRASH_CAN_RENDER_METRICS.drawSize;
...
export function looseAcornPileDrawRect(item) {
  const size = LOOSE_ACORN_PILE_RENDER_METRICS.drawSize;
  const groundY = item.y + item.h;
  return {
    x: item.x + item.w / 2 - size / 2,
    y: groundY - LEVEL_TWO_PROP_ATLAS.baseline / LEVEL_TWO_PROP_ATLAS.cell * size,
