...
export const JIMOTHY_ANIMATIONS = {
  ...
  small_jump: entry(3, 4, 8, false, 88),
  small_fall: entry(4, 4, 8, true, 88),
  small_land: entry(5, 4, 10, false, 82),
  ...
  large_jump: entry(13, 4, 8, false, 114),
  large_fall: entry(14, 4, 8, true, 114),
  large_land: entry(15, 4, 10, false, 104),
  large_tail_swipe: entry(16, 4, 14, false, 112),
  large_hurt: entry(17, 4, 8, false, 100),
  large_shrink: entry(18, 4, 10, false, 108),
  large_glide: entry(19, 4, 7, true, 140),
  large_skid: entry(20, 4, 10, false, 108),
